  ...
  return (
    <div className="min-h-screen flex bg-background">
      ...
      >
            ...
            if (isStarterLocked) {
              return (
                <button
                  ...
                  className="flex items-center gap-3 px-3 py-3.5 lg:py-2.5 w-full rounded-xl lg:rounded-lg text-base lg:text-sm font-medium transition-all duration-200 text-sidebar-foreground/60 hover:bg-sidebar-accent/30 min-h-[48px] lg:min-h-0"
                >
        ...
        <div className="px-3 py-4 border-t border-sidebar-border/50 space-y-2 lg:space-y-1">
          {supportWhatsapp && (
            <a
              href={`https://wa.me/${supportWhatsapp.replace(/\D/g, "")}`}
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2.5 px-3 py-3 lg:py-2.5 w-full rounded-xl lg:rounded-lg text-sm font-medium text-green-400 hover:bg-green-500/10 transition-all duration-200 min-h-[44px] lg:min-h-0"
            >
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div className="relative flex items-center pointer-events-auto">
              ...
              <img
                ...
                src={defaultBrandLogo}
                alt="Meu Gestor – Logo"
                className="relative h-14 sm:h-[3.75rem] object-contain drop-shadow-[0_0_10px_hsl(var(--primary)/0.4)]"
                loading="eager"
                decoding="sync"
                fetchPriority="high"
              />
