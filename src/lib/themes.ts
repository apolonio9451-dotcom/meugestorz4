...
export const themePresets: ThemePreset[] = [
  ...
  },
  {
    ...
    cssVars: {
      ...
      "--primary": "174 72% 56%",
      "--primary-foreground": "180 40% 4%",
      "--secondary": "174 35% 10%",
      "--secondary-foreground": "170 15% 93%",
      "--muted": "174 25% 12%",
      "--muted-foreground": "174 20% 50%",
      "--accent": "174 68% 48%",
      "--accent-foreground": "180 40% 4%",
      "--border": "174 40% 24%",
      "--input": "174 28% 13%",
      "--ring": "174 72% 56%",
      "--sidebar-background": "174 50% 5%",
      "--sidebar-foreground": "174 30% 70%",
      "--sidebar-primary": "174 72% 56%",
      "--sidebar-primary-foreground": "180 40% 4%",
      "--sidebar-accent": "174 35% 14%",
      "--sidebar-accent-foreground": "174 20% 90%",
      "--sidebar-border": "174 30% 16%",
      "--sidebar-ring": "174 72% 56%",
      "--glass-bg": "174 38% 9%",
      "--glass-border": "174 60% 42%",
