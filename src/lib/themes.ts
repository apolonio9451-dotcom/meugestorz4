...
export const themePresets: ThemePreset[] = [
  ...
  },
  {
    ...
    cssVars: {
      ...
      "--primary": "174 72% 56%",
      "--primary-foreground": "195 50% 5%",
      "--secondary": "192 40% 10%",
      "--secondary-foreground": "180 20% 93%",
      "--muted": "192 30% 13%",
      "--muted-foreground": "185 18% 52%",
      "--accent": "174 70% 50%",
      "--accent-foreground": "195 50% 5%",
      "--border": "180 45% 22%",
      "--input": "192 32% 12%",
      "--ring": "174 72% 56%",
      "--sidebar-background": "198 50% 5%",
      "--sidebar-foreground": "180 25% 65%",
      "--sidebar-primary": "174 72% 56%",
      "--sidebar-primary-foreground": "195 50% 5%",
      "--sidebar-accent": "190 38% 13%",
      "--sidebar-accent-foreground": "180 20% 90%",
      "--sidebar-border": "190 30% 15%",
      "--sidebar-ring": "174 72% 56%",
      "--glass-bg": "190 40% 10%",
      "--glass-border": "174 65% 45%",
