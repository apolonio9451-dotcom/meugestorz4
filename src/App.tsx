      ...
      <BrowserRouter>
        <AuthProvider>
          <Routes>
            ...
            {/* Reseller pages integrated into main dashboard */}
            <Route path="/dashboard/my-clients" element={<DashboardRoute><ResellerClients /></DashboardRoute>} />
            <Route path="/dashboard/my-credits" element={<DashboardRoute><ResellerCredits /></DashboardRoute>} />
            {/* Legacy reseller routes redirect */}
